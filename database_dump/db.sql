...
CREATE TYPE "account_external" AS ENUM (
  'GOOGLE',
  'OPEN_ID'
);
...
CREATE TABLE "refresh_token_metadata" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
  "user_id" integer NOT NULL,
...
CREATE TABLE "users" (
  ...
  "created_at" timestamp NOT NULL,
  "auth_status" bool NOT NULL,
  "external_status" account_external NOT NULL
);
...
ALTER TABLE "refresh_token_metadata" ADD CONSTRAINT "refresh_token_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id");
